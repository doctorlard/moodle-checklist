...
class provider implements \core_privacy\local\metadata\provider,
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($items as $item) {
            ...
            $teachermark = !empty($teachermarks[$item->teachermark]) ? $teachermarks[$item->teachermark] : '';
            $itemdata[] = (object)[
     ...
     * @param \stdClass $user
     */
    protected static function export_checklist_data_for_user(array $items, $cmid, \stdClass $user) {
